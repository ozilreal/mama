...
class Petugas extends CI_Controller
{
	...
	{
		parent::__construct();
		 $this->load->helper('relay'); // Tambahkan ini
	...
	public function start()
	{
		...
		if ($waktu == "kosong") {
			...
			$this->db->insert('tb_rental', $data2);
 			control_relay($id_ch, 'on'); // <-- BARU DITAMBAHKAN
	...
	public function stop()
	{
		...
		$id_ch = $this->input->post('id_ch'); // Pastikan ada input id_channel
    		control_relay($id_ch, 'off'); // <-- BARU DITAMBAHKAN
		if ($id_pk == "KO") {
			$data = [
	...
	public function penjualan()
	{
		...
		$data = [
			'title' => 'PlayStation | Data Transaksi Penjualan',
			'log' => $this->m_user->user_login(),
	...
	public function cetak_kartu($nik)
	{
		chek_belom_login();
		$data = [
			'title' => 'PlayStation | Cetak Data Member',
			'log' => $this->m_user->user_login(),
	...
	public function sewa()
	{
		...
		$data = [
			'title' => 'PlayStation | Data Sewa Harian',
			'log' => $this->m_user->user_login(),
	...
	public function invoice()
	{
		...
		$data = [
			'title' => 'PlayStation | Invoice Harian',
			'log' => $this->m_user->user_login(),
	...
	public function ubah_password()
	{
		...
		public function auto_stop() {
        	...
        	// Update status di database
       		 $this->db->where('idchannel', $id_ch)
                 ->update('tb_rental', ['aktif' => 'N']);
        
        	// Kontrol relay
        	control_relay($id_ch, 'off');
