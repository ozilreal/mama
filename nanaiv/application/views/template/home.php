                        ...
                        ?>
                            <div class="col-xl-3 col-sm-4 col-xs-4 mb-2">
                                <div class="bg-secondary rounded text-center  p-4 cnl" id="bor<?= $p->id_channel ?>">
                                    ...
                                    <a id="stpp<?= $p->id_channel ?>" class="btn btn-primary btn-md btn_stop" data-hpk="<?= $paket_ps->id_paket ?>" data-pk="KO" data-nm="<?= $p->nama_channel ?>" data-idch="<?= $p->id_channel ?>" data-idrt="<?= $m->id_rental ?>" data-idmm="<?= $m->id_member ?>" data-toggle="tooltip" title="STOP"> STOP <i class="fa fa-stop-circle "></i></a>
                                    ...
                                    <a hidden id="stp<?= $p->id_channel ?>" data-hpk="KO" class="btn btn-primary btn-md btn_stop" data-pk="<?= $paket_ps->id_paket ?>" data-nm="<?= $p->nama_channel ?>" data-idch="<?= $p->id_channel ?>" data-idrt="<?= $m->id_rental ?>" data-idmm="<?= $m->id_member ?>">STOP <i class="fa fa-stop-circle "></i></a>
                                    <?php if ($log->level == 1) {; ?>
            ...
            <div class="bg-secondary rounded  sticky-top p-4" style="min-height: 87vh; border: 1px solid grey;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="<?= site_url('petugas/sewa'); ?>"><button class="btn btn-lg btn-outline-primary btn-block w-100 btn-pro  "><i class="fa fa-laptop me-1"></i> SEWA PS</button></a>
                    </div>
                    <div class="col-md-6 mb-3">
                        <a href="<?= site_url('petugas/penjualan'); ?>"><button class="btn btn-lg btn-outline-primary btn-block w-100 btn-pro"><i class="fa fa-shopping-cart me-1"></i> PENJUALAN</button></a>
                    </div>
                    <br>
                    <div class="col-md-6 ">
                        <a href="<?= site_url('petugas/member'); ?>"><button class="btn btn-lg btn-outline-primary btn-block w-100 btn-pro"><i class="fa fa-users me-1"></i> DATA MEMBER</button></a>
                    </div>
                    <div class="col-md-6 ">
                        <a href="<?= site_url('petugas/invoice'); ?>"><button class="btn btn-lg btn-outline-primary btn-block w-100 btn-pro"><i class="fa fa-print me-1"></i> CETAK INVOICE</button></a>
                    </div>
                </div>
