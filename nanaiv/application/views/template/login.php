                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="<?= base_url('auth'); ?>" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="username" class="form-control text-white" id="floatingInput" required autofocus>
                            ...
                            <p class="text-center mb-0">Copyright <?= date('Y') ?> @PlayStation</p>
                        </form>
                    </div>
                </div>
            </div>
