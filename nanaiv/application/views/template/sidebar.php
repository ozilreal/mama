...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        <a href="<?= site_url('dashboard'); ?>" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="fa fa-gamepad me-2"></i> PlayStation</h3>
        </a>
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                <img class="rounded-circle" src="<?= base_url('assets/'); ?>img/us.png" alt="" style="width: 40px; height: 40px;">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0 ">
                    ...
                    <a href="<?= site_url('playstation/sewa'); ?>" class="dropdown-item <?= ($activeMenu == 'sw') ? 'active' : ''; ?>"><i class="fa fa-bullseye me-2"></i>Harag Sewa Harian</a>
                </div>
            </div>
