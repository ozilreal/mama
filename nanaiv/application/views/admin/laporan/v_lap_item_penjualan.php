...
<div class="page ">
    <?php if ($result->num_rows() > 0) {; ?>
        <img src="<?= base_url('assets/img/struk.png'); ?>" alt="" style="width: 90px;">
        <div class="head">
            ...
            ?>
                ...
                <?php foreach ($jml->result() as $p) {; ?>
                    <tr style="background-color: #F2F2DF;">
                        ...
                        <?php if ($nom > 2) {; ?>
                            <?php if ($nor++ == 1) {; ?>
                                <td class="bg-warning" rowspan="<?= $nom - 1; ?>">Rp <span style="float:right;"><?= number_format($t->jml_total); ?>,-</span></td>
                                <td class="bg-white" rowspan="<?= $nom - 1; ?>">Rp <span style="float:right;"><?= number_format($dbyr); ?>,-</span></td>
                                <td class="bg-white" rowspan="<?= $nom - 1; ?>">Rp <span style="float:right;"><?= number_format($t->jml_total - $dbyr); ?>,-</span></td>
                            <?php }; ?>
                        <?php } else {; ?>
